...
namespace Skills_International {
    ...
    public partial class StudentDataSet : global::System.Data.DataSet {
        ...
        public partial class RegistrationDataTable : global::System.Data.TypedTableBase<RegistrationRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public RegistrationRow AddRegistrationRow(string firstName, string lastName, System.DateTime dateOfBirth, string gender, string address, string email, int mobilePhone, string nic) {
...
namespace Skills_International.StudentDataSetTableAdapters {
    ...
    public partial class RegistrationTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Registration] ([firstName], [lastName], [dateOfBirth], [gender], [address], [email], [mobilePhone], [nic]) VALUES (@firstName, @lastName, @dateOfBirth, @gender, @address, @email, @mobilePhone, @nic);
SELECT regNo, firstName, lastName, dateOfBirth, gender, address, email, mobilePhone, nic FROM Registration WHERE (regNo = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Registration] SET [firstName] = @firstName, [lastName] = @lastName, [dateOfBirth] = @dateOfBirth, [gender] = @gender, [address] = @address, [email] = @email, [mobilePhone] = @mobilePhone, [nic] = @nic WHERE (([regNo] = @Original_regNo) AND ((@IsNull_firstName = 1 AND [firstName] IS NULL) OR ([firstName] = @Original_firstName)) AND ((@IsNull_lastName = 1 AND [lastName] IS NULL) OR ([lastName] = @Original_lastName)) AND ((@IsNull_dateOfBirth = 1 AND [dateOfBirth] IS NULL) OR ([dateOfBirth] = @Original_dateOfBirth)) AND ((@IsNull_gender = 1 AND [gender] IS NULL) OR ([gender] = @Original_gender)) AND ((@IsNull_address = 1 AND [address] IS NULL) OR ([address] = @Original_address)) AND ((@IsNull_email = 1 AND [email] IS NULL) OR ([email] = @Original_email)) AND ((@IsNull_mobilePhone = 1 AND [mobilePhone] IS NULL) OR ([mobilePhone] = @Original_mobilePhone)) AND ((@IsNull_nic = 1 AND [nic] IS NULL) OR ([nic] = @Original_nic)));
SELECT regNo, firstName, lastName, dateOfBirth, gender, address, email, mobilePhone, nic FROM Registration WHERE (regNo = @regNo)";
        ...
        public virtual int Delete(int Original_regNo, string Original_firstName, string Original_lastName, global::System.Nullable<global::System.DateTime> Original_dateOfBirth, string Original_gender, string Original_address, string Original_email, global::System.Nullable<int> Original_mobilePhone, string Original_nic) {
        ...
        public virtual int Insert(string firstName, string lastName, global::System.Nullable<global::System.DateTime> dateOfBirth, string gender, string address, string email, global::System.Nullable<int> mobilePhone, string nic) {
            if ((firstName == null)) {
        ...
        public virtual int Update(
            ...
            this.Adapter.UpdateCommand.Parameters[8].Value = ((int)(Original_regNo));
            if ((Original_firstName == null)) {
            ...
            if ((Original_mobilePhone.HasValue == true)) {
                ...
                this.Adapter.UpdateCommand.Parameters[22].Value = ((int)(Original_mobilePhone.Value));
            }
            else {
            ...
            this.Adapter.UpdateCommand.Parameters[25].Value = ((int)(regNo));
        ...
        public virtual int Update(
                    ...
                    global::System.Nullable<int> Original_mobilePhone, 
                    string Original_nic) {
            return this.Update(firstName, lastName, dateOfBirth, gender, address, email, mobilePhone, nic, Original_regNo, Original_firstName, Original_lastName, Original_dateOfBirth, Original_gender, Original_address, Original_email, Original_mobilePhone, Original_nic, Original_regNo);
        }
    }
